...
{
    public partial class frmCallinPaymentAli : Form
    {
        public frmCallinPaymentAli()
        {
            InitializeComponent();
        }
        ...
        private void frmCallinPaymentAli_Load(object sender, EventArgs e)
        {
            MaximizeBox = false;
        }
        ...
        private void btnPaymentConfirm_Click(object sender, EventArgs e)
        {
            ...
            {//Initiating SQL connection
                ...
                string sql = "INSERT INTO Dr_M_Ali([Patient's Name],[Patient's Email],[Patient's Mobile],[Appointment Date],[Trx ID])" +
                              "VALUES(" + "'" + name + "'" + ","
                                        + "'" + email + "'" + ","
                                        + "'" + phoneNumber + "'" + ","
                                        + "'" + appointmentDate + "'" + ","
