...
{
    public partial class frmInPersonPaymentJasmin : Form
    {
        public frmInPersonPaymentJasmin()
        {
            InitializeComponent();
        }
        ...
        private void frmInPersonPaymentJasmin_Load(object sender, EventArgs e)
        {
            MaximizeBox = false;
        }
        ...
        private void btnPaymentConfirm_Click(object sender, EventArgs e)
        {
            ...
            {//Initiating SQL connection
                ...
                string sql = "INSERT INTO Dr_Jasmin_Manzoor([Patient's Name],[Patient's Email],[Patient's Mobile],[Appointment Date],[Trx ID])" +
                              "VALUES(" + "'" + name + "'" + ","
                                        + "'" + email + "'" + ","
                                        + "'" + phoneNumber + "'" + ","
                                        + "'" + appointmentDate + "'" + ","
