...
{
    public partial class frmBangladeshSpecializedHospitalICUPayment : Form
    {
        public frmBangladeshSpecializedHospitalICUPayment()
        {
            InitializeComponent();
        }
        ...
        private void frmBangladeshSpecializedHospitalICUPayment_Load(object sender, EventArgs e)
        {
            MaximizeBox = false;
        }
        ...
        private void btnPaymentConfirm_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql = "INSERT INTO bookedBangladeshSpecializedHospital(Name,Email,[Phone Number],[Trx ID])" +
                              "VALUES(" + "'" + name + "'" + ","
                                        + "'" + email + "'" + ","
                                        + "'" + phoneNumber + "'" + ","
                                        + "'" + trxID + "'"
                ...
                con1.Open();
                string count = "";
                string hospitalName = "Bangladesh Specialized Hospital";
