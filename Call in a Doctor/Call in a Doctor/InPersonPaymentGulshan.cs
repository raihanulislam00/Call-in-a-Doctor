...
{
    public partial class frmInPersonPaymentGulshan : Form
    {
        public frmInPersonPaymentGulshan()
        {
            InitializeComponent();
        }
        ...
        private void frmInPersonPaymentGulshan_Load(object sender, EventArgs e)
        {
            MaximizeBox = false;
        }
