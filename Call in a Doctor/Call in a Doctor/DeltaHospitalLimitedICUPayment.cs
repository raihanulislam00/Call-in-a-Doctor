...
{
    public partial class frmDeltaHospitalLimitedICUPayment : Form
    {
        public frmDeltaHospitalLimitedICUPayment()
        {
            InitializeComponent();
        }
        ...
        private void btnPaymentConfirm_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql = "INSERT INTO bookedDeltaHospitalLimited(Name,Email,[Phone Number],[Trx ID])" +
                              "VALUES(" + "'" + name + "'" + ","
                                        + "'" + email + "'" + ","
                                        + "'" + phoneNumber + "'" + ","
                                        + "'" + trxID + "'"
                ...
                con1.Open();
                string count = "";
                string hospitalName = "Delta Hospital Limited";
