...
{
    public partial class frmInPersonPaymentAlim : Form
    {
        public frmInPersonPaymentAlim()
        {
            InitializeComponent();
        }
        ...
        private void frmInPersonPaymentAlim_Load(object sender, EventArgs e)
        {
            MaximizeBox = false;
        }
        ...
        private void btnPaymentConfirm_Click(object sender, EventArgs e)
        {
            ...
            else//Initiating SQL connection
            {
                ...
                string sql = "INSERT INTO Dr_Alim_Akhtar_Bhuiyan([Patient's Name],[Patient's Email],[Patient's Mobile],[Appointment Date],[Trx ID])" +
                              "VALUES(" + "'" + name + "'" + ","
                                        + "'" + email + "'" + ","
                                        + "'" + phoneNumber + "'" + ","
                                        + "'" + appointmentDate + "'" + ","
